        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              I’m an Information Technology engineering student with a strong
              interest in web development and software engineering. I enjoy
              building practical projects using modern technologies and
              continuously improving my problem-solving skills. I’m driven by
              curiosity, teamwork, and the goal of growing into a skilled
            ...
            <div className="p-6 bg-blue-600 rounded-2xl text-white shadow-xl shadow-blue-200">
              ...
              <p className="text-blue-50 leading-relaxed">
                Detail-oriented developer with hands-on internship experience at
                Ignitech, specializing in automation and API integration.
                Committed to building scalable web applications and continuous
                learning in modern tech stacks.
              </p>
            </div>
          </div>
        </div>
