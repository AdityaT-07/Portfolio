            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-6">
                  ...
                  <p className="text-white">adityathakur6076@email.com</p>
                </div>
                <div className="flex items-center gap-6">
                  <Phone className="text-blue-400" />
                  <p className="text-white">+91 74149 56780</p>
                </div>
                <div className="flex items-center gap-6">
            ...
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem]">
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-5 bg-blue-600 text-white font-bold rounded-2xl flex justify-center gap-2"
                >
